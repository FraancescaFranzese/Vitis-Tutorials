...
public:
  ...
  bilinear_graph()
  {
    for (int i = 0; i < NCORE; i++) {
      ...
      iplio_A[i] = input_plio::create(iplio_A_name, plio_32_bits, iplio_A_file, 625.0);
      iplio_B[i] = input_plio::create(iplio_B_name, plio_32_bits, iplio_B_file, 625.0);
      iplio_C[i] = input_plio::create(iplio_C_name, plio_32_bits, iplio_C_file, 625.0);
      oplio[i] = output_plio::create(oplio_name, plio_32_bits, oplio_file, 625.0);
