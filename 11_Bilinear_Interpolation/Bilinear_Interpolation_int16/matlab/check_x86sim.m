...
for idx = 1:num_core
    ...
    tv_img((core_pxl_cnt+1):(core_pxl_cnt+length(tv_data))) = tv_data;
    aie_sim_img((core_pxl_cnt+1):(core_pxl_cnt+length(sim_data))) = sim_data;
...
% calculate error compared to int16 test vectors
